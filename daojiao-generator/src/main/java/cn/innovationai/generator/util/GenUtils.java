package cn.innovationai.generator.util;
...
public class GenUtils
{
    ...
    public static VelocityContext getVelocityContext(TableInfo table)
    {
        ...
        velocityContext.put("classname", table.getClassname());
        velocityContext.put("moduleName", getModuleName(packageName,table.getTableName()));
     ...
     * @return 模块名
     */
    public static String getModuleName(String packageName,String tableName)
    {
